<nav id="navbar-main" class="navbar fixed-top navbar-expand-xl navbar-light bg-light">
    <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <ul class="main-nav nav">
                        ...
                        <li><a class="nav-item nav-link" target="_blank" href="https://www.rosbacher.de/">Produktvielfalt</a></li>
                    </ul>
                </div>
            </div>
        </div>
